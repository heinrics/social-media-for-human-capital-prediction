...
bachelor = get_model_scores(folds_dict, outcome, shapl=shapl)

# Print model scores
bachelor["scores_table"]
bachelor["scores_table"].to_csv(output_path + r"\hyperparams\bachelor.csv")
...
college = get_model_scores(folds_dict, outcome, shapl=shapl)

# Print model scores
print(college["scores_table"].loc["stack"])
college["scores_table"].to_csv(output_path + r"\hyperparams\college.csv")
...
high = get_model_scores(folds_dict, outcome, shapl=shapl)

# Print model scores
print(high["scores_table"].loc["stack"])
high["scores_table"].to_csv(output_path + r"\hyperparams\high.csv")
