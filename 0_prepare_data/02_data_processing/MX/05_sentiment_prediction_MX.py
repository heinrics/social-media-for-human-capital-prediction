...
if __name__ == '__main__':
    ...
    # Expand columns
    sentiment_export_df = pd.concat([sentiment_df.drop(columns=['sentiment', 'hate_speech', 'offen_lang'], axis=1),
    ...
    sentiment_export_df = pd.concat([sentiment_export_df, missing_df],
