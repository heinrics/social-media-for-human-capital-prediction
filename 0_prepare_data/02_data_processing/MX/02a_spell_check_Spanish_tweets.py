...
# Run spell checking for all [SPANISH] tweets
...
# Spell-check older tweet series - sequence during server update
input_path = base_path + '/01-data/data_server_update/la_tweets-2021-07-Jan-19.txt'
output_dir = base_path + '/02-preprocessing/01-spell-checking/spanish-3/' # spanish, spanish-2, spanish-3
...
USED_LANGUAGE_TWEET = 'es'
USED_LANGUAGE_TOOL = 'es'
